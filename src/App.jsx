      ...
      leftPanel={
        activeWorkspace === "Modeling" ? (
          <MeshEditorPanel
            ...
            onBoolean={() => {}}
            onUVUnwrap={() => {}}
            onOpenUVEditor={() => setShowUVEditor(true)}
            onOpenMatEditor={() => setShowMatEditor(true)}
          />
        ) : (
          <FeatureIndexPanel
            title={`${activeWorkspace} Tools`}
            features={WORKSPACE_FEATURES[activeWorkspace] || []}
          />
        )
      }
      centerPanel={
