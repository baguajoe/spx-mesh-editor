...
<canvas ref={canvasRef} />
      ...
      {greasePencilPanelOpen && (
        <div style={{position:"fixed",top:60,right:0,width:320,height:"calc(100vh - 60px)",zIndex:55,background:"#0d1117",borderLeft:"1px solid #21262d",display:"flex",flexDirection:"column",overflow:"hidden"}}>
          <GreasePencilPanel
            onApplyFunction={applyFunction}
